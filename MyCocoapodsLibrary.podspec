...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
TODO: Esta libreria es de para pruebas academicas.
                       DESC

  s.homepage         = 'https://github.com/allanmadrizgonzalez/MyCocoapodsLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Allan' => 'amadrizg@gmail.com' }
  s.source           = { :git => 'https://github.com/allanmadrizgonzalez/MyCocoapodsLibrary.git', :tag => s.version.to_s }
